...
$query = "UPDATE kwitansi SET no_kwitansi='$no_kwitansi',tanggal_penetapan='$tanggal_penetapan',petugas_penetapan='$petugas_penetapan',tarif_biaya='$tarif_biaya',denda='$denda'  
