...
<div class="modal fade" id="tambahDataKendaraan" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data</h5>
            ...
            <div class="modal-body">
                <form action="../config/tambah_kendaraan.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_kendaraan" id="id_kendaraan">
                    <div class="form-group">
                        <span>No.Polisi</span>
                        <input type="text" name="no_polisi" class="form-control form-control-user" id="no_polisi" required>
                    </div>
                    <div class="form-group">
                        <span>No.Polisi Lama</span>
                        <input type="text" name="no_polisi_lama" class="form-control form-control-user" id="no_polisi_lama" required>
                    </div>
                    <div class="form-group">
                        <span>No.BPKB</span>
                        <input type="text" name="no_bpkb" class="form-control form-control-user" id="no_bpkb" required>
                    </div>
                    <div class="form-group">
                        <span>No.STNK</span>
                        <input type="text" name="no_stnk" class="form-control form-control-user" id="no_stnk" required>
                    </div>
                    <div class="form-group">
                        <span>No.Rangka</span>
                        <input type="text" name="no_rangka" class="form-control form-control-user" id="no_rangka" required>
                    </div>
                    <div class="form-group">
                        <span>No.Mesin</span>
                        <input type="text" name="no_mesin" class="form-control form-control-user" id="no_mesin" required>
                    </div>
                    <div class="form-group">
                        <span>No.Pabean</span>
                        <input type="text" name="no_pabean" class="form-control form-control-user" id="no_pabean" required>
                    </div>
                    <div class="form-group">
                        <span>Kode Lokasi</span>
                        <input type="text" name="kode_lokasi" class="form-control form-control-user" id="kode_lokasi" required>
                    </div>
                    <div class="form-group">
                        <span>Merk Kendaraan</span>
                        <input type="text" name="merk_kendaraan" class="form-control form-control-user" id="merk_kendaraan" required>
                    </div>
                    <div class="form-group">
                        <span>Model Kendaraan</span>
                        <input type="text" name="model_kendaraan" class="form-control form-control-user" id="model_kendaraan" required>
                    </div>
                    <div class="form-group">
                        <span>Tahun Buat</span>
                        <input type="text" name="tahun_buat" class="form-control form-control-user" id="tahun_buat" required>
                    </div>
                    <div class="form-group">
                        <span>Jumlah Roda</span>
                        <input type="text" name="jumlah_roda" class="form-control form-control-user" id="jumlah_roda" required>
                    </div>
                    <hr>
                    <input class="btn btn-primary btn-user btn-block" type="submit" name="tambah" value="Tambah">
                </form>
...
<!-- Modal tambah data kwitansi-->
<div class="modal fade" id="tambahDataKwitansi" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data</h5>
            ...
            <div class="modal-body">
                <form action="../config/tambah_kwitansi.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_kwitansi" class="form-control form-control-user" id="id_kwitansi">
                    <div class="form-group">
                        <span>ID Pemilik</span>
                        <input type="text" name="id_wp" class="form-control form-control-user" id="id_wp" required>
                    </div>
                    <div class="form-group">
                        <span>ID Kendaraan</span>
                        <input type="text" name="id_kendaraan" class="form-control form-control-user" id="id_kendaraan" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="tambahDataAdmin" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data</h5>
            ...
            <div class="modal-body">
                <form action="../config/tambah_admin.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group w-100 mb-5">
                        <select class="form-control " name="bagian" id="bagian">
                            ...
                            <option value="Petuugas">Petugas</option>
                        </select>
                    </div>
                    <hr>
                    <input class="btn btn-primary btn-user btn-block" type="submit" name="tambah" value="Tambah">
...
<div class="modal fade" id="editPemilik" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="../config/edit_pemilik.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editKendaraan" tabindex="-1" role="dialog" aria-labelledby="editDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data</h5>
            ...
            <div class="modal-body">
                <form action="../config/edit_kendaraan.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_kendaraan" id="id_kendaraan">
                    <div class="form-group">
                        <span>No.Polisi</span>
                        <input type="text" name="no_polisi" class="form-control form-control-user" id="no_polisi" required>
...
<div class="modal fade" id="editKwitansi" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../config/edit_kwitansi.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_kwitansi" id="id_kwitansi">
                    <input type="hidden" name="id_kendaraan" class="form-control form-control-user" id="id_kendaraan">
                    <input type="hidden" name="id_kendaraan" class="form-control form-control-user" id="id_kendaraan">
                    ...
                    <div class="form-group w-100 mb-5">
                        ...
                        <select class="form-control " name="keterangan_lunas">
                            <option>--Pilih--</option>
